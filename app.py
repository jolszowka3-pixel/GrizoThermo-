...
# Funkcja do kolorowania tabeli na pulpicie
...
if menu == "📊 Pulpit & Stany":
    ...
    with col2:
        ...
        # Aplikujemy style Pandas do tabeli
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Min_Stan": None  # Ukrywamy kolumnę Min_Stan na pulpicie dla czystości
            }
        )
...
# ------------------------------------------
    ...
    st.info("💡 Tylko kolumny **Stan Aktualny** są edytowalne. Kliknij wartość, wpisz poprawną i zatwierdź przyciskiem na dole.")
